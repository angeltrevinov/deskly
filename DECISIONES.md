...
###[Decisión] DEC-0026 - Extraer componentes reutilizables del detalle de ticket
**Contexto:** la ruta SSR de `/tickets/[id]` concentraba en un solo archivo la estructura de resumen, comentarios y estado de error, lo que dificultaba reutilizar esas piezas fuera de esa página.
**Uso de LLM:** se le pidió a Copilot sacar esa estructura, incluidos los comments, a componentes reutilizables fuera del archivo de página.
